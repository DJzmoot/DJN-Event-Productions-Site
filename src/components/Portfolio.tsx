...
const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    image: '/RiverheadMerryMarket1.gif',
    category: 'Audio',
...
const normalizeCategory = (s: string) => s.trim().toLowerCase().replace(/\s+/g, ' ');
...
export function Portfolio() {
  ...
  // Find featured item within the CURRENT filter set (not just "All")
  const featuredItem = filteredItems.find((item) => item.featured);

  // If we’re rendering a featured card, don’t duplicate it in the grid
